...
- reasoner `fixed_ladder`, adapter `simulator`, 3.83s over 168 ticks
...
- reasoner `heuristic`, adapter `simulator`, 3.67s over 168 ticks
...
- reasoner `heuristic`, adapter `simulator`, 4.28s over 168 ticks
